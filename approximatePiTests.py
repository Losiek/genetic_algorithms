...
def display(candidate, startTime, bitValues):
    ...
    print("{}/{}\t{}\t{}".format(
        numerator, denominator, candidate.Fitness, timeDiff))
...
def mutate(genes, numBits):
    numeratorIndex, denominatorIndex = random.randrange(0, numBits), \
...
class ApproximatePiTests(unittest.TestCase):
    ...
    def test_benchmark(self):
        genetic.Benchmark.run(lambda: self.test([98, 334, 38, 339, 117,
                                                 39, 145, 123, 40, 129]))
